...
flowchart TD
    ...
    Report --> S3Upload["☁️ Upload Masked Output to S3"]
...
├── 📁 frontend/
│   └── 📁 src/
│       ├── ⚛️  App.js          # Main React app: Auth0, polling, UI state
│       ├── 🎨 App.css          # Dark-mode glassmorphism design system
│       └── ⚛️  index.js        # Auth0Provider, app bootstrap
├── 🐳 Dockerfile               # Multi-stage build (Node → Python)
├── ⚙️  supervisord.conf        # Process orchestration: Redis + FastAPI + Celery
...
**Built with ❤️ — combining Cloud, AI, and Security into a single production-grade application.**
